...
function get_server_time() {
    ...
    document.getElementById('showtime').innerHTML = '<img src="images/ajax loader.jpg" alt="Loading..." style="max-width: 20%; height: auto;">';
    xmlhttp.send(null);
}
...
function add_customer_get() {
    ...
    if (name != "" && address != "" && city != "") {
        ...
        xmlhttp.onreadystatechange = function () {
            document.getElementById(inner).innerHTML = '<img src="images/ajax loader.jpg" alt="Loading..." style="max-width: 20%; height: auto;">';
            if ((xmlhttp.readyState == 4) && (xmlhttp.status == 200)) {
