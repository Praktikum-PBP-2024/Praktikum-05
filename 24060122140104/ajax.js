...
function searchBooks(keywords) {
    var inner = 'book-details';
    var url = 'get_books.php?title=' + encodeURIComponent(keywords);
    if (keywords == "") {
        document.getElementById(inner).innerHTML = '<table class="table table-striped"><tr><td colspan="6" align="center">Nothing to see here.</td></tr></table>';
    } else {
        callAjax(url, inner);
    }
}
