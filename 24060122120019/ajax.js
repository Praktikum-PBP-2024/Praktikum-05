...
function get_server_time() {
    ...
    xmlhttp.onreadystatechange = function() {
        document.getElementById('showtime').innerHTML = '<img src="./image/loading.jpg">';
...
function add_customer_get() {
    ...
    if (name != "" && address != "" && city != "") {
        ...
        xmlhttp.onreadystatechange = function() {
            document.getElementById(inner).innerHTML = '<img src="./images/loading.jpg"/>';
            if ((xmlhttp.readyState == 4) && (xmlhttp.status == 200)){
...
function searchBooks(keywords) {
    ...
    if (keywords == "") {
		...
		<table class="table table-striped">
			<tr>
				<td colspan="6" align="center">Your search did not return any result.</td>
			</tr>
		</table>';
    } else {
        callAjax(url, inner);
